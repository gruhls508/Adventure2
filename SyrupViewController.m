...
- (void)viewDidLoad
{
    ...
    self.textViewOne.text = [NSString stringWithFormat:@"The first face they recognize in Tinseltown is Thorny from Super Troopers. %@'s like \"Syrup-chugging contest. Now.\" Max is like \"Horrible idea.\" Thorny says \"You don't have a mustache. You can't win.\"", localHeroCopy];
